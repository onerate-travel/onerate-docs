...
Every screen has a language switcher. On the sign-in page it is a drop-down list beside the
heading; inside the portal it is the globe in the header bar, showing the two-letter code of the
language you are reading — press it for the full list. Either way the seven are English, Türkçe,
Български, Magyar, Italiano, Polski and Română, each named in itself, so look for the name as you
would write it. Your choice is remembered on that browser.
